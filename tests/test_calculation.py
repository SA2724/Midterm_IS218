"""Test module for arithmetic operations: Addition, Subtraction, Multiplication, Division."""
...
def test_addition(a, b, expected):
    ...
    assert repr(operation) == (
        f"Addition(a={a}, b={b}, result={expected})"
    )
...
def test_subtraction(a, b, expected):
    ...
    assert repr(operation) == (
        f"Subtraction(a={a}, b={b}, result={expected})"
    )
...
def test_multiplication(a, b, expected):
    ...
    assert repr(operation) == (
        f"Multiplication(a={a}, b={b}, result={expected})"
    )
...
def test_division(a, b, expected):
    ...
    assert repr(operation) == (
        f"Division(a={a}, b={b}, result={expected})"
    )
